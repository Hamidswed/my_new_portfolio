        ...
        <div className="animate-slide-left space-y-8">
          <div className="glass rounded-2xl p-6 hover-lift">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  <h3 className="font-semibold dark:text-dark-text light:text-light-text">{t('common.emailLabel')}</h3>
                  <a 
                    href="mailto:delshad.swdn@gmail.com" 
                    className="dark:text-dark-muted light:text-light-muted hover:text-dark-primary transition-colors duration-300"
                  >
                    {t('common.emailValue')}
                  </a>
                </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  <h3 className="font-semibold dark:text-dark-text light:text-light-text">{t('common.phone')}</h3>
                  <a 
                    href="tel:+46735883889" 
                    className="dark:text-dark-muted light:text-light-muted hover:text-dark-secondary transition-colors duration-300"
                  >
                    {t('common.phoneValue')}
                  </a>
                </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  <h3 className="font-semibold dark:text-dark-text light:text-light-text">{t('common.locationLabel')}</h3>
                  <p className="dark:text-dark-muted light:text-light-muted">{t('common.locationValue')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass rounded-2xl p-6 hover-lift">
            <h3 className="text-xl font-bold dark:text-dark-text light:text-light-text mb-4">
              {t('contact.quickStats')}
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold gradient-text">24h</div>
                <div className="text-sm dark:text-dark-muted light:text-light-muted">{t('contact.responseTime')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold gradient-text">100%</div>
                <div className="text-sm dark:text-dark-muted light:text-light-muted">{t('contact.clientSatisfaction')}</div>
              </div>
            </div>
          </div>
        </div>

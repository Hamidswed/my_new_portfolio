...
export function WebList() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div
        className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-r dark:from-dark-accent/10 dark:to-dark-primary/10 light:from-light-accent/10 light:to-light-primary/10 rounded-full blur-3xl animate-pulse"

    ...
    <div className=" flex flex-col items-center mt-8">
      <div className=" text-darkColor w-full flex flex-col items-center justify-center gap-4 sm:flex-row sm:items-end">
        ...
        <div className="sm:flex-1 lg:max-w-[50%]">
          ...
          <div className="w-full flex flex-col gap-2 min-[480px]:flex-row min-[480px]:justify-between min-[480px]:items-center">
            <Link to={Pdf} target="_blank" download="CV_HamidrezaDelshad" className="min-[480px]:order-2">

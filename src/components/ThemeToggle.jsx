...
export function ThemeToggle() {
  ...
  if (isDark === null) {
    return (
      <div className="fixed top-6 right-6 z-50 rounded-full p-3 bg-gray-200 dark:bg-gray-800 animate-pulse">
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-6 right-6 z-50 glass rounded-full p-3 border dark:border-dark-border/30 light:border-light-border/30 dark:hover:border-dark-primary/50 light:hover:border-light-primary/50 transition-all duration-300 hover-lift group"
